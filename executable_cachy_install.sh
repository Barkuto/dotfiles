...
paru -S --noconfirm firefox yazi cachy-update xdg-terminal-exec packet rustdesk-bin onlyoffice-bin hyprpolkitagent xdg-desktop-portal-hyprland gnome-keyring libsecret
